...
import com.example.state_hoisting.ui.theme.StateHoistingTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_ConvertToStateless()
            1 -> Practice2_ShareState()
            2 -> Practice3_StateHolder()
        }
    }
}
