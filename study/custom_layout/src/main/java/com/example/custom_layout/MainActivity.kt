...
import com.example.custom_layout.ui.theme.CustomLayoutTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_StaggeredColumn()
            1 -> Practice2_ReverseFlowRow()
            2 -> Practice3_EqualWidthColumn()
        }
    }
}
