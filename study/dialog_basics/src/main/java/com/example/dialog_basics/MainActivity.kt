...
import com.example.dialog_basics.ui.theme.DialogBasicsTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_BasicDialog()
            1 -> Practice2_InputDialog()
            2 -> Practice3_CustomDialog()
        }
    }
}
