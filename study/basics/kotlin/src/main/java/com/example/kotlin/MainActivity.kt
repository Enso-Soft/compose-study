...
import com.example.kotlin.ui.theme.KotlinBasicsTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_LambdaScreen()
            1 -> Practice2_ExtensionScreen()
            2 -> Practice3_NullSafetyScreen()
        }
    }
}
