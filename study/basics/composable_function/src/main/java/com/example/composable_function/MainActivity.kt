...
import com.example.composable_function.ui.theme.ComposableFunctionTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_ComposableScreen()
            1 -> Practice2_StateScreen()
            2 -> Practice3_ConditionalScreen()
        }
    }
}
