...
import com.example.effect_handlers_advanced.ui.theme.EffectHandlersAdvancedTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_SearchWithDebounce()
            1 -> Practice2_DynamicMessageTimer()
            2 -> Practice3_SeparateUIAndSideEffect()
        }
    }
}
