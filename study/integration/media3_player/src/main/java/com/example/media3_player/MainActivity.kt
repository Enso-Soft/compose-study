...
import com.example.media3_player.ui.theme.Media3PlayerTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_BasicPlayer()
            1 -> Practice2_CustomControls()
            2 -> Practice3_Playlist()
        }
    }
}
