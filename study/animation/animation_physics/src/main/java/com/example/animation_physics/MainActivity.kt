...
import com.example.animation_physics.ui.theme.AnimationPhysicsTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_BounceButton()
            1 -> Practice2_DragSnapCard()
            2 -> Practice3_SwipeToDelete()
        }
    }
}
