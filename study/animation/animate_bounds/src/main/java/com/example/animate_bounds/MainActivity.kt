...
import com.example.animate_bounds.ui.theme.AnimateBoundsTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_BasicAnimateBounds()
            1 -> Practice2_CustomBoundsTransform()
            2 -> Practice3_ListReorder()
        }
    }
}
