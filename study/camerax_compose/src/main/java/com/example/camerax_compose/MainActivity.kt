...
import com.example.camerax_compose.ui.theme.CameraXComposeTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_BasicPreview()
            1 -> Practice2_PhotoCapture()
            2 -> Practice3_CameraSwitch()
        }
    }
}
