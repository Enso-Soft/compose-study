...
import com.example.haptic_feedback.ui.theme.HapticFeedbackTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_LikeButtonScreen()
            1 -> Practice2_VolumeSliderScreen()
            2 -> Practice3_DragDropScreen()
        }
    }
}
