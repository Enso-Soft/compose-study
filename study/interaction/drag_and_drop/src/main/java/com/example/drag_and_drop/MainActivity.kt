...
import com.example.drag_and_drop.ui.theme.DragAndDropTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_BasicDragAndDropScreen()
            1 -> Practice2_VisualFeedbackScreen()
            2 -> Practice3_KanbanBoardScreen()
        }
    }
}
