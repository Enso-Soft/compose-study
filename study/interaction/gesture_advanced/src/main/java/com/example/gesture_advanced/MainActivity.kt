...
import com.example.gesture_advanced.ui.theme.GestureAdvancedTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_PinchZoomScreen()
            1 -> Practice2_ZoomPanScreen()
            2 -> Practice3_FlingScreen()
        }
    }
}
