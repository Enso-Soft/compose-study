...
import com.example.scaffold_and_theming.ui.theme.ScaffoldAndThemingTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_CustomColorScheme()
            1 -> Practice2_ScaffoldSetup()
            2 -> Practice3_DarkModeToggle()
        }
    }
}
