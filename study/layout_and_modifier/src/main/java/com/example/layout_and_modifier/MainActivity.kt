...
import com.example.layout_and_modifier.ui.theme.LayoutAndModifierTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_LayoutScreen()
            1 -> Practice2_BoxScreen()
            2 -> Practice3_ModifierScreen()
        }
    }
}
