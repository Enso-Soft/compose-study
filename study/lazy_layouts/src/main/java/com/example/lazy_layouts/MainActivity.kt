...
import com.example.lazy_layouts.ui.theme.LazyLayoutsTheme
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        Row(
            ...
            FilterChip(
                ...
                label = { Text("DerivedState") }
            )
        }

        when (selectedPractice) {
            0 -> Practice1_KeyScreen()
            1 -> Practice2_ContentTypeScreen()
            2 -> Practice3_DerivedStateScreen()
        }
    }
}
