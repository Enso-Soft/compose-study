...
import com.example.custom_modifier.ui.theme.CustomModifierTheme
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        Row(
            ...
            FilterChip(
                ...
                label = { Text("PointerNode") }
            )
        }

        when (selectedPractice) {
            0 -> Practice1_ConditionalModifier()
            1 -> Practice2_DrawModifierNode()
            2 -> Practice3_PointerInputNode()
        }
    }
}
