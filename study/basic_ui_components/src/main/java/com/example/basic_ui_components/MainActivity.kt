...
import com.example.basic_ui_components.ui.theme.BasicUIComponentsTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_TextScreen()
            1 -> Practice2_ButtonScreen()
            2 -> Practice3_TextFieldScreen()
        }
    }
}
