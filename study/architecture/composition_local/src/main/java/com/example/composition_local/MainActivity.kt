...
import com.example.composition_local.ui.theme.CompositionLocalTheme
...
fun MainScreen() {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("CompositionLocal 학습") }
            )
        }
    ) { innerPadding ->
        Column(
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_SpacingScreen()
            1 -> Practice2_StaticVsDynamicScreen()
            2 -> Practice3_NestedProviderScreen()
        }
    }
}
