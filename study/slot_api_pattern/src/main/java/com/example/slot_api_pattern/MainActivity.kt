...
import com.example.slot_api_pattern.ui.theme.SlotApiPatternTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_AlertBanner()
            1 -> Practice2_ScopedSlot()
            2 -> Practice3_CompoundComponent()
        }
    }
}
