...
import com.example.textfield_state.ui.theme.TextFieldStateTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_EmailField()
            1 -> Practice2_CreditCardField()
            2 -> Practice3_MarkdownEditor()
        }
    }
}
