...
import com.example.produce_state.ui.theme.ProduceStateTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_TimerScreen()
            1 -> Practice2_ProductListScreen()
            2 -> Practice3_CountdownScreen()
        }
    }
}
