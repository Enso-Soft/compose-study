...
import com.example.secure_textfield.ui.theme.SecureTextFieldTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_BasicSecureTextField()
            1 -> Practice2_PasswordToggle()
            2 -> Practice3_LoginForm()
        }
    }
}
