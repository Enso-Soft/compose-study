 ...
 *
 * 참고: TextFieldState는 다음 버전에서 완전히 지원됩니다:
 * - Compose Foundation 1.8+
 * - Material 3 1.4.0+
 * - Compose BOM 2025.04.01+
 *
 * 2025년 8월 기준 Stable API로 승격됨 (BasicTextField2 -> BasicTextField)
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Text(
                    text = """
                        ...
                        |- Compose BOM 2025.04.01+
                        |
                        |2025년 8월: Stable API로 승격됨!
                        |
                        |핵심 API:
                        |1. rememberTextFieldState() - 상태 생성
                        |2. InputTransformation - 입력 필터링
                        |3. OutputTransformation - 표시 변환
                        |4. TextFieldBuffer.edit {} - 편집
                        |5. SecureTextField - 비밀번호
                        |
