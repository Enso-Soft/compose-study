...
import com.example.date_picker.ui.theme.DatePickerTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_BirthdayPicker()
            1 -> Practice2_HotelReservation()
            2 -> Practice3_WorkdaySelection()
        }
    }
}
