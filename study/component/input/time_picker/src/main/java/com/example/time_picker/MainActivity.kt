...
import com.example.time_picker.ui.theme.TimePickerTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_BasicTimePicker()
            1 -> Practice2_TimePickerDialog()
            2 -> Practice3_AlarmTimeRange()
        }
    }
}
