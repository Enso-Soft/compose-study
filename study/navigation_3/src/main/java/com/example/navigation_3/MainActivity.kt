...
import com.example.navigation_3.ui.theme.Navigation3Theme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_BasicNavigation()
            1 -> Practice2_NavigationWithArgs()
            2 -> Practice3_AdvancedBackStack()
        }
    }
}
