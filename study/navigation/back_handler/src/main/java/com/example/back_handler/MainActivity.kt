...
import com.example.back_handler.ui.theme.BackHandlerTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_CounterBackHandler()
            1 -> Practice2_FormBackHandler()
            2 -> Practice3_NestedBackHandler()
        }
    }
}
