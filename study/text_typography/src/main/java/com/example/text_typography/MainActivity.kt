...
import com.example.text_typography.ui.theme.TextTypographyTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_HashtagScreen()
            1 -> Practice2_MentionScreen()
            2 -> Practice3_SearchScreen()
        }
    }
}
