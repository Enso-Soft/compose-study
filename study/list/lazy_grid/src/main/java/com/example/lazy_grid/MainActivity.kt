...
import com.example.lazy_grid.ui.theme.LazyGridTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_FixedGridScreen()
            1 -> Practice2_AdaptiveGridScreen()
            2 -> Practice3_StaggeredGridScreen()
        }
    }
}
