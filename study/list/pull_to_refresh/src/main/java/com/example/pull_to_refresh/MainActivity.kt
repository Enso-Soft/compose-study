...
import com.example.pull_to_refresh.ui.theme.PullToRefreshTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_BasicPullToRefresh()
            1 -> Practice2_CustomColor()
            2 -> Practice3_CustomIndicator()
        }
    }
}
