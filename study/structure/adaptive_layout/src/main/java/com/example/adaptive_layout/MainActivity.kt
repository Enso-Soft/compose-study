...
import com.example.adaptive_layout.ui.theme.AdaptiveLayoutTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_DisplayWindowSize()
            1 -> Practice2_AdaptiveLayout()
            2 -> Practice3_AdaptiveNavigation()
        }
    }
}
