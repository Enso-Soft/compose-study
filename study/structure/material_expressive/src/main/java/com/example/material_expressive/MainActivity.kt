...
import com.example.material_expressive.ui.theme.MaterialExpressiveStudyTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_ExpressiveTheme()
            1 -> Practice2_SpatialAnimation()
            2 -> Practice3_FabMenu()
        }
    }
}
