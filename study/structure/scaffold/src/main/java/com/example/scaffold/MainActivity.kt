...
import com.example.scaffold.ui.theme.ScaffoldBasicsTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_BasicScaffold()
            1 -> Practice2_WithSnackbar()
            2 -> Practice3_FullScaffold()
        }
    }
}
