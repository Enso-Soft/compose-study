...
import com.example.rich_text.ui.theme.RichTextTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_HighlightScreen()
            1 -> Practice2_InlineIconScreen()
            2 -> Practice3_ClickableLinkScreen()
        }
    }
}
