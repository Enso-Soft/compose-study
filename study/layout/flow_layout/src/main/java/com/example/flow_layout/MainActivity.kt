...
import com.example.flow_layout.ui.theme.FlowLayoutTheme
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        Row(
            ...
            FilterChip(
                ...
                label = { Text("FlowColumn") }
            )
        }

        when (selectedPractice) {
            0 -> Practice1_TagCloud()
            1 -> Practice2_GridLayout()
            2 -> Practice3_FlowColumn()
        }
    }
}
