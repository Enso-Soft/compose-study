...
import com.example.canvas_drawing.ui.theme.CanvasDrawingTheme
...
fun PracticeNavigator() {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        when (selectedPractice) {
            0 -> Practice1_SunIconScreen()
            1 -> Practice2_StarScreen()
            2 -> Practice3_CircularProgressScreen()
        }
    }
}
